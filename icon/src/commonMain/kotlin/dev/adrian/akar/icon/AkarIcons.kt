...
import dev.adrian.akar.icon.generated.resources.Res
import dev.adrian.akar.icon.generated.resources.material_symbols_rounded
...
object AkarIcons {
    ...
    fun rememberIcon(
        ...
        rememberVariableIconFont(
            ...
            weights = arrayOf(FontWeight(400)),
    ...
    const val MobileLandscape: Char = '\ue0d3'

    const val Mobile: Char = '\ue0d4'

    const val MobileAlert: Char = '\ue0d6'
    ...
    const val MobileCancel: Char = '\ue0db'

    const val MobileLockPortrait: Char = '\ue0dc'

    const val MobileSound: Char = '\ue0dd'

    const val MobileGear: Char = '\ue0de'
    ...
    const val MobileLockLandscape: Char = '\ue1be'

    const val MobileRotateLock: Char = '\ue1c0'

    const val MobileRotate: Char = '\ue1c1'
    ...
    const val MobileArrowUpRight: Char = '\ue1fe'

    const val DeviceThermostat: Char = '\ue1ff'

    const val MobileCheck: Char = '\ue200'
    ...
    const val Mobile2: Char = '\ue324'

    const val Mobile3: Char = '\ue325'
    ...
    const val MobileQuestion: Char = '\ue339'

    const val HeadsetOff: Char = '\ue33a'

    const val XCircle: Char = '\ue349'

    const val AlignCenter: Char = '\ue356'

    const val PersonShield: Char = '\ue384'
    ...
    const val MobileCameraFront: Char = '\ue3b1'

    const val MobileCameraRear: Char = '\ue3b2'
    ...
    const val MobileArrowDown: Char = '\ue62a'

    const val MobileCast: Char = '\ue62b'

    const val MobileVibrate: Char = '\ue62d'
    ...
    const val MobileArrowRight: Char = '\ue702'
    ...
    const val MobileShareStack: Char = '\ue9c5'
    ...
    const val Crown: Char = '\uecb3'

    const val _3d: Char = '\ued38'

    const val Snowflake: Char = '\ued5b'

    const val FormatImageInlineLeft: Char = '\ueeac'

    const val FormatImageFront: Char = '\ueead'

    const val FormatImageBreakRight: Char = '\ueeae'

    const val FormatImageBreakLeft: Char = '\ueeaf'

    const val FormatImageBack: Char = '\ueeb0'

    const val Undereye: Char = '\ueeb1'

    const val Lips: Char = '\ueeb2'

    const val Eyebrow: Char = '\ueeb3'

    const val ComputerSound: Char = '\ueeb4'

    const val WidgetMenu: Char = '\ueeb7'

    const val MicGear: Char = '\ueeba'

    const val PersonText: Char = '\ueebd'

    const val VoiceChatOff: Char = '\ueebe'

    const val DetectionAndZoneOff: Char = '\ueebf'

    const val NotificationAudioOff: Char = '\ueec0'

    const val NotificationAudio: Char = '\ueec1'

    const val StickerAdd: Char = '\ueec2'

    const val ChevronLineUp: Char = '\ueec3'

    const val Passport: Char = '\ueec4'

    const val YCircle: Char = '\ueec5'

    const val TriangleCircle: Char = '\ueec6'

    const val SquareCircle: Char = '\ueec7'

    const val RectangleAdd: Char = '\ueec8'

    const val GamepadUp: Char = '\ueec9'

    const val GamepadRight: Char = '\ueeca'

    const val GamepadLeft: Char = '\ueecb'

    const val GamepadDown: Char = '\ueecc'

    const val GamepadCircleUp: Char = '\ueecd'

    const val GamepadCircleRight: Char = '\ueece'

    const val GamepadCircleLeft: Char = '\ueecf'

    const val GamepadCircleDown: Char = '\ueed0'

    const val GameTriggerRight: Char = '\ueed1'

    const val GameTriggerLeft: Char = '\ueed2'

    const val GameStickRight: Char = '\ueed3'

    const val GameStickR3: Char = '\ueed4'

    const val GameStickLeft: Char = '\ueed5'

    const val GameStickL3: Char = '\ueed6'

    const val GameButtonZr: Char = '\ueed7'

    const val GameButtonZl: Char = '\ueed8'

    const val GameButtonR2: Char = '\ueed9'

    const val GameButtonR1: Char = '\ueeda'

    const val GameButtonR: Char = '\ueedb'

    const val GameButtonL2: Char = '\ueedc'

    const val GameButtonL1: Char = '\ueedd'

    const val GameButtonL: Char = '\ueede'

    const val GameBumperRight: Char = '\ueedf'

    const val GameBumperLeft: Char = '\ueee0'

    const val CircleCircle: Char = '\ueee1'

    const val BCircle: Char = '\ueee2'

    const val ArrowsUpDownCircle: Char = '\ueee3'

    const val ArrowsLeftRightCircle: Char = '\ueee4'

    const val BookmarkStacks: Char = '\ueee8'

    const val WatchLock: Char = '\ueee9'

    const val MobileUnlock: Char = '\ueeea'

    const val AssignmentGlobe: Char = '\ueeec'

    const val ChatDashed: Char = '\ueeed'

    const val FrameExclamation: Char = '\ueeee'

    const val FrameBug: Char = '\ueeef'

    const val FitnessTrackers: Char = '\ueef1'

    const val FamilyGroup: Char = '\ueef2'

    const val MailAsterisk: Char = '\ueef4'

    const val ArrowShapeUp: Char = '\ueef6'

    const val ArrowShapeUpStack: Char = '\ueef7'

    const val ArrowShapeUpStack2: Char = '\ueef8'

    const val SearchGear: Char = '\ueefa'

    const val PageMenuIos: Char = '\ueefb'

    const val ThumbsUpDouble: Char = '\ueefc'

    const val AndroidCell5Bar: Char = '\uef02'

    const val AndroidCell5BarPlus: Char = '\uef03'

    const val AndroidCell5BarOff: Char = '\uef04'

    const val AndroidCell5BarAlert: Char = '\uef05'

    const val AndroidCell4Bar: Char = '\uef06'

    const val AndroidCell4BarPlus: Char = '\uef07'

    const val AndroidCell4BarOff: Char = '\uef08'

    const val AndroidCell4BarAlert: Char = '\uef09'

    const val AndroidCellDual5Bar: Char = '\uef0a'

    const val AndroidCellDual5BarPlus: Char = '\uef0b'

    const val AndroidCellDual5BarAlert: Char = '\uef0c'

    const val AndroidCellDual4Bar: Char = '\uef0d'

    const val AndroidCellDual4BarPlus: Char = '\uef0e'

    const val AndroidCellDual4BarAlert: Char = '\uef0f'

    const val AndroidWifi4Bar: Char = '\uef10'

    const val AndroidWifi4BarQuestion: Char = '\uef11'

    const val AndroidWifi4BarPlus: Char = '\uef12'

    const val AndroidWifi4BarOff: Char = '\uef13'

    const val AndroidWifi4BarLock: Char = '\uef14'

    const val AndroidWifi4BarAlert: Char = '\uef15'

    const val AndroidWifi3Bar: Char = '\uef16'

    const val AndroidWifi3BarQuestion: Char = '\uef17'

    const val AndroidWifi3BarPlus: Char = '\uef18'

    const val AndroidWifi3BarOff: Char = '\uef19'

    const val AndroidWifi3BarLock: Char = '\uef1a'

    const val AndroidWifi3BarAlert: Char = '\uef1b'

    const val BucketCheck: Char = '\uef2a'

    const val TableSign: Char = '\uef2c'

    const val SettingsSeating: Char = '\uef2d'

    const val PartnerHeart: Char = '\uef2e'

    const val Conversation: Char = '\uef2f'

    const val ChildHat: Char = '\uef30'

    const val Yakitori: Char = '\uef31'

    const val Udon: Char = '\uef32'

    const val TatamiSeat: Char = '\uef33'

    const val TakeoutDining2: Char = '\uef34'

    const val SoloDining: Char = '\uef35'
    ...
    const val MobileSensorHi: Char = '\uf005'

    const val MobileSensorLo: Char = '\uf006'
    ...
    const val ShavedIce: Char = '\uf225'

    const val RestArea: Char = '\uf22a'

    const val StackedLineChart: Char = '\uf22b'

    const val RequestPage: Char = '\uf22c'

    const val ParentChildDining: Char = '\uf22d'
    ...
    const val MealLunch: Char = '\uf23c'

    const val MealDinner: Char = '\uf23d'

    const val KanjiAlcohol: Char = '\uf23e'

    const val HanamiDango: Char = '\uf23f'

    const val CalendarMeal2: Char = '\uf240'

    const val AwardMeal: Char = '\uf241'

    const val CalendarLock: Char = '\uf242'

    const val CalendarCheck: Char = '\uf243'

    const val PercentDiscount: Char = '\uf244'

    const val MoneyRange: Char = '\uf245'

    const val BriefcaseMeal: Char = '\uf246'

    const val ImageInset: Char = '\uf247'

    const val WindshieldDefrostAuto: Char = '\uf248'

    const val MailShield: Char = '\uf249'

    const val BatteryAndroidFrameShield: Char = '\uf24b'

    const val BatteryAndroidFrameShare: Char = '\uf24c'

    const val BatteryAndroidFrameQuestion: Char = '\uf24d'

    const val BatteryAndroidFramePlus: Char = '\uf24e'

    const val BatteryAndroidFrameFull: Char = '\uf24f'

    const val BatteryAndroidFrameBolt: Char = '\uf250'

    const val BatteryAndroidFrameAlert: Char = '\uf251'

    const val BatteryAndroidFrame6: Char = '\uf252'

    const val BatteryAndroidFrame5: Char = '\uf253'

    const val BatteryAndroidFrame4: Char = '\uf254'

    const val BatteryAndroidFrame3: Char = '\uf255'

    const val BatteryAndroidFrame2: Char = '\uf256'

    const val BatteryAndroidFrame1: Char = '\uf257'

    const val SignLanguage2: Char = '\uf258'

    const val Drone2: Char = '\uf259'

    const val Drone: Char = '\uf25a'

    const val ChessRook: Char = '\uf25b'

    const val ChessQueen: Char = '\uf25c'

    const val ChessPawn2: Char = '\uf25d'

    const val ChessKnight: Char = '\uf25e'

    const val ChessKing: Char = '\uf25f'

    const val ChessKing2: Char = '\uf260'

    const val ChessBishop: Char = '\uf261'

    const val ChessBishop2: Char = '\uf262'

    const val TranslateIndic: Char = '\uf263'

    const val SyncSavedLocallyOff: Char = '\uf264'

    const val Eyeglasses2Sound: Char = '\uf265'

    const val ResetExposure: Char = '\uf266'

    const val AutoStoriesOff: Char = '\uf267'

    const val CarDefrostMidLowRight: Char = '\uf277'

    const val CarDefrostMidLeft: Char = '\uf278'

    const val NestFarsightSeasonal: Char = '\uf279'

    const val NestFarsightHeat: Char = '\uf27a'

    const val NestFarsightEco: Char = '\uf27b'

    const val NestFarsightDual: Char = '\uf27c'

    const val NestFarsightCool: Char = '\uf27d'

    const val CheckCircleUnread: Char = '\uf27e'

    const val Yoshoku: Char = '\uf27f'

    const val Washoku: Char = '\uf280'

    const val Okonomiyaki: Char = '\uf281'

    const val MountainSteam: Char = '\uf282'

    const val JapaneseFlag: Char = '\uf283'

    const val JapaneseCurry: Char = '\uf284'

    const val BeerMeal: Char = '\uf285'

    const val BathBedrock: Char = '\uf286'

    const val SubwayWalk: Char = '\uf287'

    const val ParkingValet: Char = '\uf288'

    const val ParkingSign: Char = '\uf289'

    const val ParkingMeter: Char = '\uf28a'

    const val MopedPackage: Char = '\uf28b'

    const val GarageMoney: Char = '\uf28c'

    const val GarageCheck: Char = '\uf28d'

    const val Playground: Char = '\uf28e'

    const val Playground2: Char = '\uf28f'

    const val PersonHeart: Char = '\uf290'

    const val MenuBook2: Char = '\uf291'

    const val HeartSmile: Char = '\uf292'

    const val HandPackage: Char = '\uf293'

    const val HandMeal: Char = '\uf294'

    const val DineIn: Char = '\uf295'

    const val CalendarMeal: Char = '\uf296'

    const val MapPinReview: Char = '\uf297'

    const val MapPinHeart: Char = '\uf298'

    const val TableLarge: Char = '\uf299'

    const val HighChair: Char = '\uf29a'

    const val DineLamp: Char = '\uf29b'

    const val DineHeart: Char = '\uf29c'

    const val ChairUmbrella: Char = '\uf29d'

    const val ChairFireplace: Char = '\uf29e'

    const val ChairCounter: Char = '\uf29f'

    const val BathSoak: Char = '\uf2a0'

    const val PaymentCard: Char = '\uf2a1'

    const val MovieSpeaker: Char = '\uf2a3'

    const val Pickleball: Char = '\uf2a6'

    const val Padel: Char = '\uf2a7'

    const val Badminton: Char = '\uf2a8'

    const val MobileTheft: Char = '\uf2a9'

    const val PlaneContrails: Char = '\uf2ac'

    const val ShieldToggle: Char = '\uf2ad'

    const val Timer2: Char = '\uf2ae'

    const val Timer1: Char = '\uf2af'

    const val MobileWrench: Char = '\uf2b0'

    const val DiamondShine: Char = '\uf2b2'

    const val Vignette2: Char = '\uf2b3'

    const val Tonality2: Char = '\uf2b4'

    const val MobileLayout: Char = '\uf2bf'

    const val PaymentArrowDown: Char = '\uf2c0'

    const val MusicHistory: Char = '\uf2c1'

    const val Massage: Char = '\uf2c2'

    const val HealthCross: Char = '\uf2c3'

    const val Acupuncture: Char = '\uf2c4'

    const val ApprovalDelegationOff: Char = '\uf2c5'

    const val Eyeglasses2: Char = '\uf2c7'

    const val WatchArrow: Char = '\uf2ca'

    const val MobileChat: Char = '\uf2ce'

    const val MobileCamera: Char = '\uf2cf'

    const val MobileSoundOff: Char = '\uf2e9'

    const val HearingAidDisabledLeft: Char = '\uf2ec'

    const val HearingAidLeft: Char = '\uf2ed'

    const val TabSearch: Char = '\uf2f2'

    const val Cannabis: Char = '\uf2f3'

    const val RouterOff: Char = '\uf2f4'

    const val DeviceBand: Char = '\uf2f5'

    const val ComputerCancel: Char = '\uf2f6'

    const val ComputerArrowUp: Char = '\uf2f7'

    const val SplitSceneUp: Char = '\uf2fc'

    const val SplitSceneRight: Char = '\uf2fd'

    const val SplitSceneLeft: Char = '\uf2fe'

    const val SplitSceneDown: Char = '\uf2ff'

    const val BatteryAndroidShield: Char = '\uf300'

    const val BatteryAndroidShare: Char = '\uf301'

    const val BatteryAndroidQuestion: Char = '\uf302'

    const val BatteryAndroidPlus: Char = '\uf303'

    const val BatteryAndroidFull: Char = '\uf304'

    const val BatteryAndroidBolt: Char = '\uf305'

    const val BatteryAndroidAlert: Char = '\uf306'

    const val BatteryAndroid6: Char = '\uf307'

    const val BatteryAndroid5: Char = '\uf308'

    const val BatteryAndroid4: Char = '\uf309'

    const val BatteryAndroid3: Char = '\uf30a'

    const val BatteryAndroid2: Char = '\uf30b'

    const val BatteryAndroid1: Char = '\uf30c'

    const val BatteryAndroid0: Char = '\uf30d'

    const val VerifiedOff: Char = '\uf30e'

    const val ShieldWatch: Char = '\uf30f'

    const val Landscape2Edit: Char = '\uf310'

    const val MobileHandLeftOff: Char = '\uf312'

    const val MobileHandLeft: Char = '\uf313'

    const val MobileHandOff: Char = '\uf314'

    const val ImageArrowUp: Char = '\uf317'

    const val MobileSound2: Char = '\uf318'

    const val Stars2: Char = '\uf31c'

    const val StarShine: Char = '\uf31d'

    const val WandStars: Char = '\uf31e'

    const val WandShine: Char = '\uf31f'

    const val MobileSpeaker: Char = '\uf320'

    const val MobileScreensaver: Char = '\uf321'

    const val MobileLoupe: Char = '\uf322'

    const val MobileHand: Char = '\uf323'

    const val Earbuds2: Char = '\uf324'

    const val EarbudRight: Char = '\uf325'

    const val EarbudLeft: Char = '\uf326'

    const val EarbudCase: Char = '\uf327'

    const val WindshieldHeatFront: Char = '\uf328'

    const val WindshieldDefrostRear: Char = '\uf329'

    const val WindshieldDefrostFront: Char = '\uf32a'

    const val SteeringWheelHeat: Char = '\uf32b'

    const val SeatVentRight: Char = '\uf32c'

    const val SeatVentLeft: Char = '\uf32d'

    const val SeatHeatRight: Char = '\uf32e'

    const val SeatHeatLeft: Char = '\uf32f'

    const val SeatCoolRight: Char = '\uf330'

    const val SeatCoolLeft: Char = '\uf331'

    const val HvacMaxDefrost: Char = '\uf332'

    const val FanIndirect: Char = '\uf333'

    const val FanFocus: Char = '\uf334'

    const val CarMirrorHeat: Char = '\uf335'

    const val CarLock: Char = '\uf336'

    const val CarGear: Char = '\uf337'

    const val CarFanRecirculate: Char = '\uf338'

    const val CarFanMidRight: Char = '\uf339'

    const val CarFanMidLowRight: Char = '\uf33a'

    const val CarFanMidLeft: Char = '\uf33b'

    const val CarFanLowRight: Char = '\uf33c'

    const val CarFanLowMidLeft: Char = '\uf33d'

    const val CarFanLowLeft: Char = '\uf33e'

    const val CarDefrostRight: Char = '\uf33f'

    const val CarDefrostMidRight: Char = '\uf340'

    const val CarDefrostMidLowLeft: Char = '\uf341'

    const val CarDefrostLowRight: Char = '\uf342'

    const val CarDefrostLowLeft: Char = '\uf343'

    const val CarDefrostLeft: Char = '\uf344'

    const val Fragrance: Char = '\uf345'

    const val Graph7: Char = '\uf346'

    const val SwitchAccess3: Char = '\uf34d'

    const val AccessibleMenu: Char = '\uf34e'

    const val MoonStars: Char = '\uf34f'

    const val VpnLock2: Char = '\uf350'

    const val DropperEye: Char = '\uf351'

    const val Voicemail2: Char = '\uf352'

    const val NotificationSound: Char = '\uf353'

    const val SubtitlesGear: Char = '\uf355'

    const val EarSound: Char = '\uf356'

    const val ChefHat: Char = '\uf357'

    const val StackGroup: Char = '\uf359'

    const val PlugConnect: Char = '\uf35a'

    const val AlarmPause: Char = '\uf35b'

    const val InboxTextShare: Char = '\uf35c'

    const val GlobeLocationPin: Char = '\uf35d'

    const val InboxTextPerson: Char = '\uf35e'

    const val InboxTextAsterisk: Char = '\uf360'

    const val LockOpenCircle: Char = '\uf361'

    const val StylusPencil: Char = '\uf362'

    const val StylusPen: Char = '\uf363'

    const val StylusHighlighter: Char = '\uf364'

    const val StylusFountainPen: Char = '\uf365'

    const val StylusBrush: Char = '\uf366'

    const val NotificationSettings: Char = '\uf367'

    const val ArticlePerson: Char = '\uf368'

    const val NfcOff: Char = '\uf369'

    const val BusRailway: Char = '\uf36b'

    const val BoatRailway: Char = '\uf36c'

    const val BoatBus: Char = '\uf36d'

    const val MatchCaseOff: Char = '\uf36f'

    const val SkullList: Char = '\uf370'

    const val NetworkIntelNode: Char = '\uf371'

    const val ScreenshotFrame2: Char = '\uf374'

    const val CardsStar: Char = '\uf375'

    const val ViewApps: Char = '\uf376'

    const val TimerArrowUp: Char = '\uf377'

    const val TimerArrowDown: Char = '\uf378'

    const val ThermostatArrowUp: Char = '\uf379'

    const val ThermostatArrowDown: Char = '\uf37a'

    const val SyncArrowUp: Char = '\uf37b'

    const val SyncArrowDown: Char = '\uf37c'

    const val HourglassArrowUp: Char = '\uf37d'

    const val HourglassArrowDown: Char = '\uf37e'

    const val EditArrowUp: Char = '\uf37f'

    const val EditArrowDown: Char = '\uf380'

    const val ClockArrowUp: Char = '\uf381'

    const val ClockArrowDown: Char = '\uf382'

    const val PageFooter: Char = '\uf383'

    const val PageHeader: Char = '\uf384'

    const val DocumentSearch: Char = '\uf385'

    const val CloudLock: Char = '\uf386'

    const val Planet: Char = '\uf387'

    const val Brick: Char = '\uf388'

    const val TouchTriple: Char = '\uf389'

    const val TouchLong: Char = '\uf38a'

    const val TouchDouble: Char = '\uf38b'

    const val HourglassPause: Char = '\uf38c'

    const val Flowchart: Char = '\uf38d'

    const val DatabaseSearch: Char = '\uf38e'

    const val CardsStack: Char = '\uf38f'

    const val VideocamAlert: Char = '\uf390'

    const val MusicNoteAdd: Char = '\uf391'

    const val MicAlert: Char = '\uf392'

    const val ArrowsOutput: Char = '\uf393'

    const val ArrowsInput: Char = '\uf394'

    const val FolderInfo: Char = '\uf395'

    const val FitPageWidth: Char = '\uf396'

    const val FitPageHeight: Char = '\uf397'

    const val SaveClock: Char = '\uf398'

    const val InboxText: Char = '\uf399'

    const val ShoppingBagSpeed: Char = '\uf39a'

    const val Graph6: Char = '\uf39b'

    const val Graph5: Char = '\uf39c'

    const val Graph4: Char = '\uf39d'

    const val Graph3: Char = '\uf39e'

    const val Graph2: Char = '\uf39f'

    const val Graph1: Char = '\uf3a0'

    const val DeliveryTruckSpeed: Char = '\uf3a1'

    const val DeliveryTruckBolt: Char = '\uf3a2'

    const val SirenQuestion: Char = '\uf3a4'

    const val SirenOpen: Char = '\uf3a5'

    const val SirenCheck: Char = '\uf3a6'

    const val Siren: Char = '\uf3a7'

    const val Modeling: Char = '\uf3aa'

    const val Pinboard: Char = '\uf3ab'

    const val PinboardUnread: Char = '\uf3ac'

    const val HearingAidDisabled: Char = '\uf3b0'
